...
export function createProductList(personajes) {
    let html = ""
    html += "<h1>Listado de personajes</h1>"
    // html += "<a href='/productos/agregar' >Nuevo producto</a>"
    html += "<a href='/personajes?publicado=Marvel Comics' >Marvel Comics</a> | <a href='/personajes?publicado=DC Comics' >DC Comics</a>"
    html += "<ul>"
    personajes.forEach(personaje => html += "<li>" + personaje.superhero + "</li>")
    html += "</ul>"
